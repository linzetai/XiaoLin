...
export const UserInput = memo(function UserInput({ msg, copyable, selected, onToggleSelect }: UserInputProps) {
  ...
  return (
    ...
    >
      {/* User message card with subtle background */}
      <div
      ...
      >
        {/* Header: avatar + label + timestamp + actions */}
        <div className="flex items-center gap-2 mb-1.5">
          {onToggleSelect && (
            <button
              onClick={onToggleSelect}
              className="flex h-4 w-4 shrink-0 items-center justify-center rounded border transition-colors duration-100 hover:border-[var(--fill-secondary)]"
              style={{
