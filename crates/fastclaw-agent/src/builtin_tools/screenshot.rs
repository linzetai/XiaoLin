...
use fastclaw_core::tool::{Tool, ToolImage, ToolKind, ToolParameterSchema, ToolResult};
...
fn tmp_path() -> PathBuf {
    let name = format!("fastclaw-screenshot-{}.png", std::process::id());
...
pub fn register_screenshot_tool(registry: &fastclaw_core::tool::ToolRegistry) {
