...
fn estimate_definitions_tokens(defs: &[xiaolin_core::tool::ToolDefinition]) -> usize {
...
async fn tool_search_finds_deferred_tools() {
    ...
    let search_tool = xiaolin_agent::builtin_tools::ToolSearchTool::new(registry.clone());
