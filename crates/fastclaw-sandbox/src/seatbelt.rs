...
impl ProxyPolicyInputs {
    ...
    pub fn from_env() -> Self {
        let (http_port, socks_port) = fastclaw_network_proxy::proxy_loopback_ports_from_env();
        let has_proxy = fastclaw_network_proxy::has_proxy_url_env_vars();
        ...
        Self {
            ...
            allow_local_binding: std::env::var(
                fastclaw_network_proxy::ALLOW_LOCAL_BINDING_ENV_KEY,
            )
            .is_ok(),
            unix_socket_policy: UnixDomainSocketPolicy::AllowAll,
        }
...
mod tests {
    ...
    use fastclaw_security::FileSystemSandboxEntry;
