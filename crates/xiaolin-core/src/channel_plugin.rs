...
//!
//! Channel plugins allow XiaoLin to integrate with external messaging platforms
...
/// (e.g. `~/.xiaolin/plugins/channel/<id>.json`).
...
/// Section inside `XiaoLinConfig` governing channel plugins.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
