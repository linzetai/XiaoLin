...
fn get_agent_memory<'a>(
    ...
    &'a std::sync::Arc<xiaolin_memory::EpisodicMemory>,
    &'a std::sync::Arc<xiaolin_memory::SemanticMemory>,
)> {
...
pub async fn auto_record_episode(
    ...
    let importance = xiaolin_memory::ImportanceScorer::score_single(&summary);
